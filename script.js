...
function speakText(text) {
  ...
  const speechUtternance = new SpeechSynthesisUtterance(text);
  speechUtternance.lang = document.getElementById("translateTo").value;

  speechSynthesis.speak(speechUtternance);
}
